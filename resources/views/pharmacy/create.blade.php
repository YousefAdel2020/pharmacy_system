    ...
    <div class="card card-primary">
        ...
        <form class="form p-4" action="{{ route('pharmacies.store') }}"method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <strong>
                    <p class="mt-3">For Uploading a different photo...</p>
                </strong>
            ...
            <div class="form-group">
                ...
                <input type="name"required class="form-control" id="exampleInputName1" name="name"
                    placeholder="Enter Pharmacy Name">
            </div>

            <div class="form-group">
                <label for="national_id">National-ID</label>
                <input type="number" class="form-control" requiredid="exampleInputDescreption1" name="national_id"
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" name="email"
                    placeholder="Enter Pharmacy Emaill">
            </div>
            <div class="form-group">
