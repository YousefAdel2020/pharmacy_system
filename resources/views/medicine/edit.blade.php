            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="name" class="form-control" id="exampleInputName1" name="name"
                        value="{{ $medicine->name }}" placeholder="Enter Medicine Name">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Price (in cents)</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="price"
                        value="{{ $medicine->price }}" placeholder="Enter Price in cents">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail2" name="type"
                        value="{{ $medicine->type }}" placeholder="Enter type of medicine">
                </div>
